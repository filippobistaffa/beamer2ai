...
- Piper works better than Bark with [non-English languages](https://github.com/rhasspy/piper/blob/master/VOICES.md) as well (see the examples for [Spanish](https://github.com/filippobistaffa/beamer2ai/blob/piper/spanish.py) and [Catalan](https://github.com/filippobistaffa/beamer2ai/blob/piper/catalan.py)).
