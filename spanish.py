...
if __name__ == "__main__":
    ...
    generate_video(
        ...
        scripts=[
            {
                "text": 'Bienvenidos a la presentación de nuestro trabajo enfocado en recomendar rutas verdes a peatones ' +
                        'para reducir la exposición a contaminantes del aire en Barcelona. Este es un trabajo conjunto entre ' +
                        'el Instituto de Investigación en Inteligencia Artificial y la Universidad Pompeu Fabra en Barcelona.',
                "pdf_page_number": 1,
            },
            {
        ...
        model_path="voices/es_ES-sharvard-medium.onnx",
    ...
    generate_video(
        ...
        model_path="voices/es_ES-sharvard-medium.onnx",
        output_video_path="es_chunk_2.mp4",
        resolution=(3840, 2160),
        skip=False
    )
        ...
        scripts=[
            {
                "text": 'En general, nuestras pruebas realizadas en puntos de inicio y destino populares en Barcelona muestran ' +
                        'una reducción de la exposición al N O dos de menos 7 porciento. Estos resultados corroboran la indicación de que ' +
